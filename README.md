...
<br/>
-모든 물체와 충돌이 있으면 죽는다.<br/>
-체력이 다른 적을 죽이면서 다른 점수를 얻는다(체력이 높으면 높은점수)<br/>
-적이 근처에 오면 우측 하단에 그림이 나오면서 노래가 나온다.<br/>
-적을 공격으로 제거하면 Particle로 폭팔을 시킨다.<br/>
<준비기간> 3주
